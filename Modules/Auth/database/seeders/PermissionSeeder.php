...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['name' => 'finance-payment-refund',    'target' => 'finance', 'description' => 'Memproses pengembalian dana (refund) pembayaran'],
            ...
            ['name' => 'finance-me-invoice-view',   'target' => 'finance', 'description' => 'Melihat daftar tagihan pribadi (penghuni)'],
            ['name' => 'finance-me-payment-view',   'target' => 'finance', 'description' => 'Melihat riwayat pembayaran pribadi (penghuni)'],
